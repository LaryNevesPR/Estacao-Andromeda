...
autodoc-error-missing-patient = PACIENTE DESAPARECIDO
...
# Estes intencionalmente têm russo ao lado deles para uma estética semelhante a ostranauts.
# Se você é um fork russo, eles não precisam ser traduzidos :)
...
autodoc-safety-enabled = SEGURANÇA ATIVADA БЕЗОПАСНО НА
autodoc-safety-disabled = SEGURANÇA DESATIVADA В БЕЗОПАСНОСТИ
...
autodoc-add-step-set-label = DEFINIR ETIQUETA НАНЕСИТЕ ЯРЛЫК
autodoc-add-step-set-label-prompt = Etiqueta
autodoc-add-step-wait = ESPERAR ЖДАТЬ
