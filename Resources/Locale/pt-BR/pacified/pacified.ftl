...
# Com projéteis:
pacified-cannot-throw = Não consigo jogar { THE($projectile) }, isso pode machucar alguém!
# Com projéteis embutidos:
pacified-cannot-throw-embed = De jeito nenhum eu poderia jogar { THE($projectile) }, isso poderia machucar alguém!
