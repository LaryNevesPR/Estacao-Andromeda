...
cloning-console-window-scanner-details-label = Status do analisador Genético
cloning-console-window-pod-details-label = Status da capsula de Clonagem
cloning-console-window-no-scanner-detected-label = Vincule um analisador genético a uma multiferramenta ou a um configurador de rede.
cloning-console-window-no-clone-pod-detected-label = Vincule uma capsula de clonagem a uma multiferramenta ou a um configurador de rede.
...
cloning-console-component-msg-scanner-occupant-alive = Não Está Pronto: Ocupante do analisador está vivo
cloning-console-component-msg-already-alive = Não Está Pronto: Conflito Metafísico
cloning-console-component-msg-occupied = Não Está Pronto: Capsula Já Contém Um Clone
cloning-console-component-msg-already-cloning = Não Está Pronto: Conflito De Rede Da Capsula
