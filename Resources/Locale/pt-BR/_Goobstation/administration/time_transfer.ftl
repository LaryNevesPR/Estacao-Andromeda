...
time-transfer-panel-warning-group-no-time = O tempo do grupo está vazio
time-transfer-panel-warning-add-success = Tempo adicionado com sucesso
time-transfer-panel-warning-set-success = Tempo substituído com sucesso
...
# Por favor, altere se realmente precisar fazer isso
