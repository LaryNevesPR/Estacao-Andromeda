...
glimmer-report = Nivel atual do Vislumbre: {$level}μΨ.
glimmer-event-report-generic = descarga noösférica detectada. Nivel do Vislumbre diminuiu {$decrease} até {$level}μΨ.
glimmer-event-report-signatures = Novas assinaturas psiônicas manifestadas. O nível do Vislumbre diminuiu em {$decrease} para {$level}Ψ.
