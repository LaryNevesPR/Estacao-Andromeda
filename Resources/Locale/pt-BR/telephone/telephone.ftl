# Janela de chat do telefone (prefixo e sufixo)
...
# ID do Chamador
chat-telephone-unknown-caller = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Chamador desconhecido[/bolditalic][/font][/color]
...
chat-telephone-unknown-device = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Dispositivo desconhecido[/bolditalic][/font][/color]
