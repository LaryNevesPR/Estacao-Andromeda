generic-power-initialization-feedback = Eu desperto.
already-casting = Eu não posso canalizar mais de um poder ao mesmo tempo.

# Dispersar
dispel-power-description = Dissipe entidades invocadas.
dispel-power-initialization-feedback = Os poderes do destino não significam nada para mim. Sinto como se pudesse alcançar os fios ao meu redor e impor a realidade sobre os outros.
dispel-power-metapsionic-feedback = {CAPITALIZE($entity)} é uma pedra poderosa, resistindo às correntes do destino.
...
mind-swap-power-initialization-feedback = Posso sentir os laços da alma e do corpo enfraquecerem à minha vontade, meu corpo pode ser substituído pelo de outro.
mind-swap-power-metapsionic-feedback = {CAPITALIZE($entity)} não possui um vínculo forte com seu corpo, como se sua conexão com o espírito fosse maleável.

# Choque noosférico
noospheric-zap-power-description = Atordoa a consciência do alvo, deixando-o atordoado e gaguejando.
noospheric-zap-power-initialization-feedback =
    Em um único momento transcendente, me vejo em um universo pavimentado por silício.
    Vago por este lugar por dias, desesperado para encontrar alguma forma de vida, e, ainda assim, nada me encontra.
    Pouco antes de sucumbir à sede, um homem de prata me encontra. Ele mergulha o braço em meu corpo, e eu acordo gritando.
noospheric-zap-power-metapsionic-feedback =
    Olho dentro do coração de {CAPITALIZE($entity)}, e lá, aninhado em meio à carne, gira uma pequena lasca de um ser composto de pura energia.
    Ele se volta ao meu olhar com malícia, seus olhos prateados cheios de ódio pela carne de carbono.

# Pirocinese
pyrokinesis-power-description = Ateie fogo a um alvo inflamável.
pyrokinesis-power-initialization-feedback =
    Há um brilho intenso de luz e calor, e por um instante sinto como se cada milímetro da minha carne se transformasse em vapor.
    No entanto, a morte não vem para mim, embora eu reze para que venha. O mundo além é ao mesmo tempo dolorosamente quente e gelado.
    Durante semanas, desespero que Gehenna seja real, passo fome, choro, grito, e a dor não cessa. Finalmente, um homem de branco, com o rosto de uma
    mosca monstruosa, me convida a oferecer meus serviços. Quando estendo a mão para apertar a dele, a visão desaparece, e me vejo de volta ao prime materium.
    Agora sei seu nome, é o Segredo do Fogo. Apenas ao pensar nele, posso sentir o calor daquele lugar em minhas mãos.
pyrokinesis-power-metapsionic-feedback = O Segredo do Fogo habita dentro de {CAPITALIZE($entity)}.

# Pulso metapsiônico
metapsionic-power-description = Envie um pulso mental pela área para verificar se há psiônicos próximos.
metapsionic-power-initialization-feedback =
    O mundo ao meu redor desperta com luz dos sonhos. Por um momento transcendente, vejo tudo o que é, tudo o que jamais será.
    Me vejo cambaleando, meus lábios secos não por falta de água, mas pela sede de beber do cálice do conhecimento. Eu. Devo. Encontrá-lo.
metapsionic-power-metapsionic-feedback = {CAPITALIZE($entity)} olha de volta para ti.

# Regeneração psiônica
psionic-regeneration-power-description = Leve seu metabolismo natural ao limite para impulsionar a capacidade regenerativa do corpo.
psionic-regeneration-power-initialization-feedback =
    Olho dentro de mim mesmo, encontrando uma fonte de vida.
psionic-regeneration-power-metapsionic-feedback = {CAPITALIZE($entity)} possui uma vontade avassaladora de viver.

# Palavra de cura
action-name-healing-word = Palavra de cura
action-description-healing-word = Pronuncie o menor segredo da vida e restaure a saúde de outro.
healing-word-power-description = Pronuncie o menor segredo da vida e restaure a saúde de outro.
healing-word-power-initialization-feedback =
    No início dos tempos, uma palavra foi dita que trouxe a vida para as esferas.
    Embora me canse saber disso, esse segredo agora me é conhecido.
    Eu só preciso dizê-lo.
healing-word-power-metapsionic-feedback = {CAPITALIZE($entity)} carrega o menor segredo da sida.
healing-word-begin = {CAPITALIZE($entity)} murmura uma palavra que traz tanto alegria quanto dor aos que a ouvem.

# Reviver
action-name-revivify = Sopro da vida
action-description-revivify = Pronuncie o maior segredo da vida e traga outro de volta.
revivify-power-description = Pronuncie o maior segredo da vida e traga outro de volta.
revivify-power-initialization-feedback =
    Por um momento, minha alma viaja através do tempo e do espaço até o início de tudo, lá eu o ouço.
...
telegnosis-power-initialization-feedback =
    Com meu próximo passo, percebo que já não estou no reino material. Meus pés caminham sobre uma ponte de arco-íris.
    No entanto, estranhamente, quando olho para a esquerda e para a direita, vejo primeiro uma cor que é como rosa dentro do rosa, e à minha direita, azul dentro do azul.
    Justo quando minha mente se contorce com o desgosto de conhecer cores que não são, uma criatura que só posso descrever como um
    dragão com asas de pavão desce e consome minha carne de uma só mordida. Acordo num instante, em um mundo completamente desprovido
    de cores verdadeiras e reais.
telegnosis-power-metapsionic-feedback = A alma de {CAPITALIZE($entity)} viaja por pontes compostas de luz dos sonhos.

# Invisibilidade psiônica
psionic-invisibility-power-description = Torne-se invisível para qualquer entidade que possa potencialmente ser psiônica. Borgs, animais e similares não são afetados.
psionic-invisibility-power-initialization-feedback =
    De repente, me vejo mergulhado em um mundo completamente sem luz, ainda assim posso sentir os raios de calor lançados sobre mim.
    Ponderando sobre isso, chego à conclusão de que a visão em si é uma ilusão. Eu a rejeito, nego que a luz seja real.
    Quando acordo, já não posso ver nem a mim mesmo.
psionic-invisibility-power-metapsionic-feedback = O destino de {CAPITALIZE($entity)} busca se esconder do teu olhar.

# Xenoglossia
xenoglossy-power-description = Você entende todos os idiomas.
xenoglossy-power-initialization-feedback =
    Sinto uma empatia com toda a criação, de modo que posso compreendê-los e ser {$gender ->
    [male] compreendido
    [female] compreendida
    *[other] compreendide
}.
    A barreira entre pensamento e expressões é permeável para mim.
psionic-language-power-metapsionic-feedback = A noosfera flui livremente através de {CAPITALIZE($entity)}, que parece digerir e devolver sem perturbação.
...
psychognomy-power-initialization-feedback =
    ...
    Quando a energia passa pelas perfurações na noosfera, tenho um vislumbre vago da origem material.
...
telepathy-power-initialization-feedback =
    As vozes que ouvi toda a minha vida começam a se esclarecer, mas não me abandonam. Antes, eram sussurros incoerentes,
    agora meus sentidos se ampliam, chego à conclusão de que fazem parte de uma alucinação coletiva compartilhada. Por trás de cada voz há uma centelha cintilante de consciência.

# Salto das sombras
action-name-shadeskip = Salto das sombras
...
pyrokinetic-flare-power-initialization-feedback =
    ...
    de fogo e dor, de fome e sofrimento. Assim que eu o noto, a visão desaparece. Mas a memória daquele flash permanece em minha mente.
...
examine-mindbroken-message =
    Olhos fixos, olhando profundamente para o horizonte. {CAPITALIZE($entity)} é um saco de carne fingindo ter uma alma.
    Não há nada por trás de seu olhar, nenhuma evidência pode ser encontrada da luz divina da criação.
