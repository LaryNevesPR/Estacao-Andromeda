bible-heal-success-self = Você acerta {THE($target)} com {THE($bible)}, e os seus ferimentos fecham num clarão de luz divina!
bible-heal-success-others = {CAPITALIZE(THE($user))} acerta {THE($target)} com {THE($bible)}, e os seus ferimentos fecham num clarão de luz divina!
...
bible-summon-verb-desc = Convoque um familiar que irá ajudá-lo e ganhar inteligência humana quando habitado por uma alma.
bible-summon-requested = O seu familiar irá chegar assim que uma alma disposta se voluntariar.
bible-summon-respawn-ready = {CAPITALIZE(THE($book))} surge com poder etéreo. O seu residente está em casa novamente.

necro-heal-success-self = Você acerta {THE($target)} com {THE($bible)}, e a sua carne deforma enquanto derrete!
necro-heal-success-others = {CAPITALIZE(THE($user))} acerta {THE($target)} com {THE($bible)}, e a sua carne deforma enquanto derrete!
