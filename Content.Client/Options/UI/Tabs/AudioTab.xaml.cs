...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(AndromedaCCVars.TTSVolume, SliderTts.Value / 100f * ContentAudioSystem.TtsMultiplier);
            _cfg.SetCVar(AndromedaCCVars.TTSRadioVolume, SliderTtsRadio.Value / 100f * ContentAudioSystem.TtsMultiplier);
            _cfg.SetCVar(AndromedaCCVars.TTSAnnounceVolume, SliderTtsAnnounce.Value / 100f * ContentAudioSystem.TtsMultiplier);
        ...
        private void Reset()
        {
            ...
            SliderTts.Value = _cfg.GetCVar(AndromedaCCVars.TTSVolume) * 100f / ContentAudioSystem.TtsMultiplier;
            SliderTtsRadio.Value = _cfg.GetCVar(AndromedaCCVars.TTSRadioVolume) * 100f / ContentAudioSystem.TtsMultiplier;
            SliderTtsAnnounce.Value = _cfg.GetCVar(AndromedaCCVars.TTSAnnounceVolume) * 100f / ContentAudioSystem.TtsMultiplier;
        ...
        private void UpdateChanges()
        {
            ...
            var isTtsVolumeSame =
               Math.Abs(SliderTts.Value - _cfg.GetCVar(AndromedaCCVars.TTSVolume) * 100f / ContentAudioSystem.TtsMultiplier) < 0.01f;
            var isTtsRadioSame =
               Math.Abs(SliderTtsRadio.Value - _cfg.GetCVar(AndromedaCCVars.TTSRadioVolume) * 100f / ContentAudioSystem.TtsMultiplier) < 0.01f;
            var isTtsAnnounceSame =
               Math.Abs(SliderTtsAnnounce.Value - _cfg.GetCVar(AndromedaCCVars.TTSAnnounceVolume) * 100f / ContentAudioSystem.TtsMultiplier) < 0.01f;
            ...
            SliderTtsLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", SliderTts.Value / 100));
            SliderTtsRadioLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", SliderTtsRadio.Value / 100));
            SliderTtsAnnounceLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", SliderTtsAnnounce.Value / 100));
